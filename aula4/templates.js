exports.studentsListPage = function(slist, d){
        ...
        <body>
            <div class="w3-card-4">
                ...
                <header class="w3-container w3-teal">
                    <h1>Students List
                    <a class="w3-btn w3-grey" a href="/alunos/registo">+</a></h1>
                </header>
    ...
    for(let i=0; i < slist.length ; i++){
        pagHTML += `
                <tr>
                    <td>${slist[i].id}</td>
                    <td><a href="/alunos/${slist[i].id}">
                        ${slist[i].nome}</a>
                    </td><td>${slist[i].gitlink}</td>
                    <td>
            ...
            <div class="w3-card-4">
                ...
                <form class="w3-container" method="POST">
                    <fieldset>
                        ...
                        <label>Name</label>
                        <input class="w3-input w3-round" type="text" name="name" value="${a.nome}">
                        <label>Git</label>
